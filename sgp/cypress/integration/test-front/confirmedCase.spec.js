describe('confirmar caso de paciente con COVID' , () => {
    ...
    it('add a patient' , () => {
        ...
        cy.get('[id= ControlTextAreaNN1]').type("Confirmado");
        ...
        cy.contains(`Paciente Confirmado Test ingresado con Exito!`);
    })
    ...
    it('attend a patient' , () => {
        cy.request('GET', 'http://localhost:3000/api/pacientes-esperando-atendiendose').then(res => {
            ...
            cy.contains('Confirmar caso').click();
            cy.contains('Paciente Confirmado Test confirmacion exitosa!')
