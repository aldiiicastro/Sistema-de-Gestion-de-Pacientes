...
describe('Register',()=> {
    ...
    it('delete b person too next test', () => {
        cy.request('DELETE', 'localhost:3000/api/delete/byEmail/b@gmail.com').then((response) =>{expect(response.body).to.have.property('response', 'Usuario eliminado correctamente!')      })
    })
})