describe('Tutorial Doctor', () => {
    ...
    it('delete b person too next test', () => {
        cy.request('DELETE', 'https://sistema-gestion-paciente.herokuapp.com/api/delete/byEmail/s@gmail.com').then((response) =>{expect(response.body).to.have.property('response', 'Usuario eliminado correctamente!')      })
    })
})